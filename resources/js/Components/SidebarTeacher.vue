          ...
          <ul role="list" class="pt-16">
            <li>
              <ul role="list" class="-mx-2 space-y-1">
                <li>
                <button
                        class="w-full text-white uppercase tracking-widest hover:text-purple-600 hover:bg-gray-50 group flex gap-x-3 rounded-md p-2 text-sm leading-6">
...
const isQuizFormVisible = ref(false); 
